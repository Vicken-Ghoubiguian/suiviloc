    ...
    if(isset($_POST['soumission_du_formulaire_d_authentification']))
    {
        ...
        try
        {
            ...
            elseif($nombre_de_resultats_de_la_requete == 1 && $resultat_de_la_requete_preparee_pour_identification_de_l_uttilisateur["est_connecte"] == 1)
            {
                ...
                //
                mise_a_jour_d_urgence_de_la_table_de_connexion_a_l_application_suiviloc_pour_connection_a_l_application($nom_de_l_uttilisateur_pour_authentification, $mot_de_passe_crypte_de_l_uttilisateur_pour_authentification);
