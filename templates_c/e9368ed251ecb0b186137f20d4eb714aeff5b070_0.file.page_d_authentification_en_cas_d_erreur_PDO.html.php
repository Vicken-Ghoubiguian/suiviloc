...
function content_5ca7961dc1eda7_60859149 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang='en'>
<head>
    <meta charset='UTF-8'>
...
<div id='dialog_d_indication_d_une_erreur_de_connexion' title='Erreur survenue'>
    Erreur de connexion, la voici: <?php echo $_smarty_tpl->tpl_vars['message_d_erreur_de_connexion_a_la_base_de_donnees']->value;?>
.
</div>
<div>
    <form action='authentification.php' method='post'>
        <table>
            ...
            <tr>
                ...
                <th>
                    <input class='text-danger' type='password' id='mot_de_passe_pour_authentification' name='champ_password_pour_mot_de_passe_pour_authentification' title='Entrez votre mot de passe dans ce champ; Vous pourrez modifier celui-ci avec un autre de votre choix, une fois connecté' required>
                </th>
            </tr>
            <tr>
                <th>
                    <div><input class='ui-button ui-corner-all ui-widget' type='submit' name='soumission_du_formulaire_d_authentification' value='Connectez-vous'></div>
                </th>
            </tr>
            <tr>
                <th>
                    <div><button id='bouton_d_oublis_de_mot_de_passe' class='ui-button ui-corner-all ui-widget'>Mot de passe oublié</button></div>
                </th>
            </tr>
        </table>
    </form>
